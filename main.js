...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`628975217200@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT ✿𝐒𝐀𝐍𝐒 𝐁𝐎𝐓✿ JANGAN LUPA SAVE 𝐒𝐀𝐍𝐒 𝐁𝐎𝐓, PASTI DI SAVEBACK' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = 'HALO @user 👋\n SELAMAT DATANG DI Group @subject \n❋𝗝𝗔𝗦𝗔 𝗥𝗨𝗡❋\n-𝚃𝚒𝚗𝚐𝚐𝚊𝚕 𝚂𝚌𝚊𝚗\n-𝟸𝟺𝙹𝚊𝚖 𝚋𝚘𝚝 𝚊𝚔𝚝𝚒𝚏\n𝙿𝚊𝚢𝚖𝚎𝚗𝚝 : 𝙳𝙰𝙽𝙰\n𝙼𝚒𝚗𝚊𝚝 ? wa.me/628975217200' 
  conn.bye = 'YAHHH @user TELAH KELUAR DARI Group @subject'
